 ...
 */
final class Version20181211165353 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE histoire (id INT AUTO_INCREMENT NOT NULL, genre_id INT DEFAULT NULL, user_id INT DEFAULT NULL, titre VARCHAR(100) NOT NULL, pitch TEXT NOT NULL, photo VARCHAR(256) NOT NULL, INDEX IDX_FD74CD684296D31F (genre_id), INDEX IDX_FD74CD68A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
